...
const DashboardCard = ({ children, iconName, size, to }) => {
  ...
  return (
    <Link to={to} onMouseOver={play} onMouseLeave={stop} className="bg-slate-100 hover:drop-shadow-lg rounded-md flex gap-2 justify-end flex-col items-center transition-all p-4 box-border cursor-pointer">
      {icon}
